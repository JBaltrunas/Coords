...
alphabet =\
    {
        ...
        "0": [(1, 3), (2, 2), (2, -2), (1, -3), (-1, -3), (-2, -2), (-2, 2), (-1, 3), (1, 3)],
        "1": [(-2, 1), (0, 3), (0, -3)],
        "2": [(-2, 1), (-2, 2), (-1, 3), (1, 3), (2, 2), (2, 0), (-2, -3), (2, -3)],
        "3": [(-2, 2), (-1, 3), (1, 3), (2, 2), (2, 1), (1, 0), (-1, 0), (1, 0), (2, -1), (2, -2), (1, -3), (-1, -3), (-2, -2)],
        "4": [(0, 3), (-2, 0), (2, 0), (2, 1), (2, 0), (2, -3)],
        "5": [(2, 3), (-2, 3), (-2, 0), (-1, 1), (1, 1), (2, 0), (2, -2), (1, -3), (-1, -3), (-2, -2)],
        "6": [(2, 2), (1, 3), (-1, 3), (-2, 2), (-2, -1), (-1, 0), (1, 0), (2, -1), (2, -2), (1, -3), (-1, -3), (-2, -2), (-2, 0)],
        "7": [(-2, 2), (-2, 3), (2, 3), (-2, -3)],
        "8": [(1, 0), (2, 1), (2, 2), (1, 3), (-1, 3), (-2, 2), (-2, 1), (-1, 0), (1, 0), (2, -1), (2, -2), (1, -3), (-1, -3), (-2, -2), (-2, -1), (-1, 0)],
        "9": [(2, 0), (2, 2), (1, 3), (-1, 3), (-2, 2), (-2, 1), (-1, 0), (2, 0), (2, -1), (2, -2), (1, -3), (-1, -3), (-2, -2)],

        ":": [(0, 1.75), (0.25, 1.5), (0, 1.25), (-0.25, 1.5), (0, 1.75), (None), (0, -1.75), (0.25, -1.5), (0, -1.25), (-0.25, -1.5), (0, -1.75)]
    }
t = turtle.Turtle()
